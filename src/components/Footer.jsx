    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto">
        ...
        <div className="flex justify-center space-x-4">
          ...
          <a
            href="https://twitter.com/JoeTheorium"
            className="hover:text-gray-400 text-xl"
          >
            <FaTwitter /> {/* "Twitter" or "X" */}
          </a>
          <a
            href="mailto:fernandoandresraggio@gmail.com"
            className="hover:text-gray-400 text-xl"
          >
            <FaEnvelope />
          </a>
        ...
        <p className="text-center mt-4">
          ...
          <a href="https://www.github.com/JoeTheorium">JoeTheorium</a> - All
          rights reserved.
        </p>
      </div>
    </footer>
